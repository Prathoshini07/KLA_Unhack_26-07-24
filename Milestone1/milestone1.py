...
def main():
    care_areas = load_care_areas(r'Milestone1\CareAreas.csv')
    main_field_size, sub_field_size = load_metadata(r'Milestone1\metadata.csv')
    main_fields, sub_fields = generate_fields(care_areas, main_field_size, sub_field_size)
    #for i in care_areas:
       # print(i)
    
    save_main_fields(r'Milestone1\mainfields.csv', main_fields)
    save_sub_fields(r'Milestone1\subfields.csv', sub_fields)
